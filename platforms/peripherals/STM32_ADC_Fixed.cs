...
namespace Antmicro.Renode.Peripherals.Analog
{
   ...
   public class STM32_ADC_Fixed : BasicDoubleWordPeripheral, IWordPeripheral, IBytePeripheral, IKnownSize, IGPIOReceiver
   {
      public STM32_ADC_Fixed(IMachine machine) : base(machine)
      {
